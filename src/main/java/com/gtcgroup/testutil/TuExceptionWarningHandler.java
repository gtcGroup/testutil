...
import com.gtcgroup.testutil.exception.TestUtilAbstractClassWarning;
import com.gtcgroup.testutil.exception.TestUtilEndlessLoopWarning;
import com.gtcgroup.testutil.exception.TestUtilInstantiationWarning;
import com.gtcgroup.testutil.exception.TestUtilMultiplesWarning;
import com.gtcgroup.testutil.exception.TestUtilNotVerifiableWarning;
import com.gtcgroup.testutil.exception.TestUtilSetterSignatureWarning;
import com.gtcgroup.testutil.exception.TestUtilWarningException;
import com.gtcgroup.testutil.po.TuResultsPO;
...
final class TuExceptionWarningHandler {
	...
	public synchronized static final void processWarning(final StringBuffer sbSetterName,
			final StringBuffer sbGetterName, final TuMethodPairBO tuMethodPairBO, final TuResultsPO tuCountersBO,
		...
		if (null != sbGetterName && null != sbSetterName) {
			...
			if (null != tuMethodPairBO) {
				message.append(" " + tuMethodPairBO.getTuMethodGetBO().getMethod().getName());
			}
			message.append("()]");
		}
		message.append("\n\t");
	 ...
	 */
	synchronized static final void throwAbstractClassWarning(final Class<?> clazz, final Method method,
			final Constructor<?> constructor) throws TestUtilAbstractClassWarning {
	 ...
	 */
	synchronized static final void throwEndlessLoopWarning(final int loopCounter, final Class<?> theClass) {

		// Decrement.
		int loopTemp = loopCounter;
		loopTemp--;

		throw new TestUtilEndlessLoopWarning(
	 ...
	 */
	synchronized static final void throwInstantiationWarning(final Class<?> theClass, final Exception e)
			throws TestUtilInstantiationWarning {
	 ...
	 */
	synchronized static final void throwInstantiationWarning(final Class<?> theClass, final Exception e,
			final Constructor<?>[] constructors) throws TestUtilInstantiationWarning {
	 ...
	 */
	synchronized static final void throwMultiplesWarningForGetter(final String sbGetterName)
			throws TestUtilMultiplesWarning {

		throw new TestUtilMultiplesWarning(
	 ...
	 * @throws TestUtilMultiplesWarning
	 */
	synchronized static final void throwMultiplesWarningForSetter(final String sbSetterName)
			throws TestUtilMultiplesWarning {
	 ...
	 */
	synchronized static final void throwNotVerifiableWarning(final String parameterType, final String returnType)
			throws TestUtilNotVerifiableWarning {

		throw new TestUtilNotVerifiableWarning("Setter first parameter [" + parameterType + "] and getter return type ["
	 ...
	 */
	synchronized static final void throwSetterSignatureWarning() throws TestUtilSetterSignatureWarning {
